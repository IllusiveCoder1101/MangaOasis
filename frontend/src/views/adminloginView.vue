            ...
            <main>
                <section class="login_form">
                    ...
                    <form action="" class="form">
                        ...
                        <button type="submit" class="primary form_btn" @click.prevent="()=>handleSubmit()">SIGN IN</button>
                    </form>
                </section>
                ...
                axios.post(path,payload)
                    .then((info)=>{
                        if (info.data.msg === "valid admin"){
                            ...
                            localStorage.setItem("access_key",info.data.result)
                            setTimeout(()=>{
                                this.formReset()
                                this.handleRedirect()    
                            },1000)
